// src/app/dashboard/policies/new/page.js
"use client";
...
export default function NewPolicyPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        alert(data.error || "Error al crear la póliza");
        return;
      }
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Crear Nueva Póliza</CardTitle>
          <CardDescription>Ingresá los datos de la póliza</CardDescription>
        </CardHeader>
        <CardContent>
